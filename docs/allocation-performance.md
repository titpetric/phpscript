...
| `Mail`                                           | `(*Mail, error)`; `Send` returns `error`; the server name accepted as `any`                    | OK                                                                                                                                                                                         |
